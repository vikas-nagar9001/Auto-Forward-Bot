        ...
        try:
            if category == 'main':
                text = (
                    ...
                    '• Set custom intervals for each message\n'
                ...
                text = (
                    ...
                    'A: Yes, each message can have its own interval\n\n'
                ...
                text = (
                    ...
                    '• **First forward sent immediately!**\n\n'
                    '2️⃣ **Managing Forwards**\n'
                    '• Use /status to check active forwards\n'
                    '• Use /stopfwd to stop forwarding\n'
                    '• Each message has its own interval\n'
                    '• **Each forward runs independently**\n\n'
                    ...
                    '• **All formatting is preserved** (bold, italic, quotes, etc.)\n\n'
                    '4️⃣ **Batch Sending (Anti-Spam)**\n'
                    '• Messages sent to 5 groups at a time\n'
                    '• 4-second delay between batches\n'
                    '• Prevents rate limiting and blocks\n'
